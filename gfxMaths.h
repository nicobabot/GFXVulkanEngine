...
{
	//Front
	{{0.5,0.5,-0.5,	1.0},	RED, {1.0f, 1.0f} ,{0.0,1.0,0.0}},
	{{-0.5,0.5,-0.5,1.0},	RED, {1.0f, 0.0f} ,{0.0,1.0,0.0}},
	{{-0.5,0.5,0.5,	1.0},	RED, {0.0f, 0.0f} ,{0.0,1.0,0.0}},
	{{0.5,0.5,0.5,	1.0},		RED, {0.0f, 1.0f} ,{0.0,1.0,0.0}},

	//Right
	{{-0.5,0.5,-0.5,	1.0},	CYAN, {1.0f, 1.0f}, {-1.0,0.0,0.0}},
	{{-0.5,-0.5,-0.5,	1.0},	CYAN, {1.0f, 0.0f}, {-1.0,0.0,0.0}},
	{{-0.5,-0.5,0.5,	1.0},	CYAN, {0.0f, 0.0f}, {-1.0,0.0,0.0}},
	{{-0.5,0.5,0.5,		1.0},	CYAN, {0.0f, 1.0f}, {-1.0,0.0,0.0}},

	//Back
	{{-0.5,-0.5,-0.5,	1.0},	GREEN, {1.0f, 1.0f} , {0.0,-1.0,0.0}},
	{{0.5,-0.5,-0.5,	1.0},	GREEN, {1.0f, 0.0f} , {0.0,-1.0,0.0}},
	{{0.5,-0.5,0.5,		1.0},	GREEN, {0.0f, 0.0f} , {0.0,-1.0,0.0}},
	{{-0.5,-0.5,0.5,	1.0},	GREEN, {0.0f, 1.0f} , {0.0,-1.0,0.0}},

	//Left
	{{0.5,-0.5,-0.5,	1.0},	WHITE, {1.0f, 1.0f}, {1.0,0.0,0.0}},
	{{0.5,0.5,-0.5,		1.0},		WHITE, {1.0f, 0.0f}, {1.0,0.0,0.0}},
	{{0.5,0.5,0.5,		1.0},	WHITE, {0.0f, 0.0f}, {1.0,0.0,0.0}},
	{{0.5,-0.5,0.5,		1.0},	WHITE, {0.0f, 1.0f}, {1.0,0.0,0.0}},

	////Down
	{{0.5,-0.5,-0.5,	1.0},	BLUE, {1.0f, 1.0f} , {0.0,0.0,1.0}},
	{{-0.5,-0.5,-0.5,	1.0},	BLUE, {1.0f, 0.0f} , {0.0,0.0,1.0}},
	{{-0.5,0.5,-0.5,	1.0},	BLUE, {0.0f, 0.0f} , {0.0,0.0,1.0}},
	{{0.5,0.5,-0.5,		1.0},	BLUE, {0.0f, 1.0f} , {0.0,0.0,1.0}},

	//Up
	{{0.5,0.5,0.5,		1.0},		YELLOW, {1.0f, 1.0f}, {0.0,0.0,1.0}},
	{{-0.5,0.5,0.5,		1.0},	YELLOW, {1.0f, 0.0f}, {0.0,0.0,1.0}},
	{{-0.5,-0.5,0.5,	1.0},	YELLOW, {0.0f, 0.0f}, {0.0,0.0,1.0}},
	{{0.5,-0.5,0.5,		1.0},	YELLOW, {0.0f, 1.0f}, {0.0,0.0,1.0}},
