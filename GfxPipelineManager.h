...
void CreateGraphicsPipeline_Internal(const GraphicsPipelineInfo& graphicPipelineInfo,
	VkPipelineLayout& graphicPipelineLayout, VkPipeline& graphicPipeline, bool enableBlending = false, bool enableWriteDepthTest = true, const char* VkPipelineName = "Unknown", const char* VkPipelineLayoutName = "Unknown");
